...
-- Valid Scheme symbol indentifiers 
symbol :: Parser Char
symbol = oneOf "!#$%&|*+-/:<=>?@^_~"
...
-- PARSE FUNCTIONS OF THE LISP VALUE DATA TYPES
...
-- Returns String variation of LispVal
